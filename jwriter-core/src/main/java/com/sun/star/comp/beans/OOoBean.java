...
//	{}
	...
	private OfficeConnection officeConnection;
	
	public OOoBean (String pathSoffice, Integer port) {
		this.officeConnection = new LocalOfficeConnection(pathSoffice, "uno:socket,host=localhost,port=" + port + ";urp;StarOffice.ServiceManager");
	}
	
	public OOoBean (String pathSoffice, String pipeName) {
		this.officeConnection = new LocalOfficeConnection(pathSoffice, "uno:pipe,name=" + pipeName + ";urp;StarOffice.ServiceManager");
	}
	
	public static void main(String[] args) throws com.sun.star.lang.IllegalArgumentException, CloseVetoException, NoConnectionException, IOException, SystemWindowException {
		String pipeName = getPipeName();
		System.out.println(pipeName);
//		OOoBean bean = new OOoBean("C:/Arquivos de programas/LibreOffice 3/program/soffice.exe", getPipeName());
//		OOoBean bean = new OOoBean("C:/Arquivos de programas/LibreOffice 3/program/soffice.exe", 8000);
//		OOoBean bean = new OOoBean("C:/Arquivos de programas/BrOffice.org 2.4/program/soffice.exe", getPipeName());
//		OOoBean bean = new OOoBean("C:/Arquivos de programas/BrOffice.org 2.4/program/soffice.exe", 8000);
		
//		JFrame janela = new JFrame( "" );
//		UIUtil.setIcon(janela);
//		bean.setAllBarsVisible(false);
//		bean.setStatusBarVisible(true);
//		janela.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//		UIUtil.setCenterLocation(janela);
...
//		propsLoad[0].Value = "Rich Text Format";
//		bean.loadFromURL("file:///d:/testes/documento.rtf", propsLoad);
...
//	}
		...
		throws NoConnectionException
	{
		if ( iConnection == null )
		{
			try { setOOoConnection( officeConnection ); }
			catch ( HasConnectionException aExc )
			{ /* impossible here */ }
		}

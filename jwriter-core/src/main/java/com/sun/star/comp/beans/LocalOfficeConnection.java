...
//		NativeLibraryLoader.loadLibrary( LocalOfficeConnection.class.getClassLoader(), "officebean" );
	 ...
	 */
	public LocalOfficeConnection(String pathSoffice, String unoUrl)
	{	
		// init member vars
		try 
		{
//			setUnoUrl( "uno:pipe,name=" + getPipeName() + ";urp;StarOffice.ServiceManager" );
		...
		String aSharedLibName = new File(pathSoffice).getParent() + File.separator + System.mapLibraryName(OFFICE_LIB_NAME);
		System.load( aSharedLibName );
